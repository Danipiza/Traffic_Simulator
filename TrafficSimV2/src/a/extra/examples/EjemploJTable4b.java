...
public class EjemploJTable4b extends JFrame implements ActionListener {
	...
	public EjemploJTable4b() {
		...
		btnAniadirFila = new JButton("Añadir fila");
	...
	private class MiModeloDeTabla extends AbstractTableModel {
		...
		public MiModeloDeTabla(int f, int c) {
			this.columnNames= new String[] { "columna1", "columna2", "columna3" };
			filas = f;
			cols = c;
	...
	public static void main(String[] args) {	
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				final EjemploJTable4b v = new EjemploJTable4b();
				v.setVisible(true);
			}
		});
	}
