...
public class Junction extends SimulatedObject{
	...
	// CAMBIA LA ESTRATEGIA DE dqs, DEL CURCE "id" EN EL TIEMPO "time"
	// QUE ESTA EN LA ESTRATEGIA NUEVA
	public void set_dqs(DequeuingStrategy dqs) {
		if (dqs == null ) {
			throw new IllegalArgumentException("Error, la estrategia dqs es nula");
		}
		estrategiaExtraeElementosCola = dqs;
	}
	
	// CAMBIA LA ESTRATEGIA DE lss, DEL CURCE "id" EN EL TIEMPO "time"
	// QUE ESTA EN LA ESTRATEGIA NUEVA
	public void set_lss(LightSwitchingStrategy lss) {
		if (lss == null ) {
			throw new IllegalArgumentException("Error, la estrategia lss es nula");
		}
		estrategiaCambioSemaforo = lss;		
	}
